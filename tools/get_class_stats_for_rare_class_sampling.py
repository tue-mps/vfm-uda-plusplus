...
from datasets.loader.zip_dataset import ZipDataset
...
def main():
    ...
    synthia_train_dataset = ZipDataset(
        transforms=DummyTransform(get_synthia_mapping()),
    ...
    urbansyn_train_dataset = ZipDataset(
        transforms=DummyTransform(),
        ...
        image_sub_path="rgb_",
        target_sub_path="ss_",
        zip_path=Path(root, "urbansyn_rgb.zip"),
        target_zip_path=Path(root, "urbansyn_label.zip"),
        is_urbansyn=True,
    )
    ...
    all_train_datasets = {
        ...
        "urbansyn": urbansyn_train_dataset,
    }
