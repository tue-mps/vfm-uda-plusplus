...
# https://github.com/facebookresearch/dinov2/blob/main/dinov2/eval/segmentation_m2f/ops/modules/ms_deform_attn.py
...
class MSDeformAttn(nn.Module):
    ...
    def forward(
        ...
        assert (input_spatial_shapes[:, 0] * input_spatial_shapes[:,
                                             1]).sum() == Len_in, "input_spatial_shapes: {}, Len_in: {}".format(
            input_spatial_shapes, Len_in)
